...
export const DUMMY_RESUME = [
  {
    ...
    owner: '123abc',
    content: {
      fullName: `Anthony-Charbel Esber`,
      ...
      sections: [
        {
          text: `I am a fresh graduate seeking opportunities to create but also advance my skills in the fields of Full
...
Analytical Problem-Solver, Engager in Teams, Fast Learner, Curious about Approaches`,
          sectionId: 'profile',
